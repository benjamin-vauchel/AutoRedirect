...
/**
 * AutoRedirect resolver script - runs on install.
 *
 ...
 */
/**
 * Description: Resolver script for AutoRedirect package
 * @package autoredirect
 * @subpackage build
 */
...
$pluginEvents = array('OnBeforeDocFormSave','OnEmptyTrash');
$plugins = array('AutoRedirect');
$category = 'AutoRedirect';
