<?php
/**
 * AutoRedirect transport plugins
 ...
 */
/**
 * Description:  Array of plugin objects for AutoRedirect package
 * @package autoredirect
 * @subpackage build
 */
...
$plugins[1]->fromArray(array(
    ...
    'plugincode' => getPluginContent($sources['source_core'].'/elements/plugins/autoredirect.plugin.php'),
),'',true,true);
